...
public class RecommendationServiceImpl implements RecommendationService {
	...
	@Override
	public List<Integer> sendForFeedRecommendation(String mb_id) {

		List<Integer> FeedIdxList;

		System.out.println("sendForFeedRecommendation 메서드 실행");
		...
		// FastAPI URL
		String pythonUrl = "http://localhost:8000/receive_feed_recommendation";
