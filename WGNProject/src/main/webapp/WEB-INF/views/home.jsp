		...
		<div class="feed">
			...
			<div class="post">
				...
				<div class="post-caption">
					<span class="caption-text"> 금보도 잘 안되는 도로 쪽에 새로 생긴 구로시로 라멘집인데
						완전 맛있네요 ㅋㅋㅋ 면도 쫄깃하고 시원한 국물이 일품! 분위기도 깔끔하고 다음에도 꼭 갈 생각입니다. </span> <span
						class="more-btn" onclick="toggleMore(this)">더보기</span>
				</div>
			</div>
			...
			<div class="post">
				...
				<div class="post-caption">
					<span class="caption-text"> 또 가고 싶은 라멘 맛집! 양도 많고 국물도 진하고 면발도
						탱탱해서 최고였어요. </span> <span class="more-btn" onclick="toggleMore(this)">더보기</span>
				</div>
			</div>
